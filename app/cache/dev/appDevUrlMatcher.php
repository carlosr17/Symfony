    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/search')) {
            ...
            if (rtrim($pathinfo, '/') === '/search') {
                if (substr($pathinfo, -1) !== '/') {
                    return $this->redirect($pathinfo.'/', 'search_homepage');
                }

                return array (  '_controller' => 'search\\searchBundle\\Controller\\DefaultController::busquedaAction',  '_route' => 'search_homepage',);
            }

            // search_key
            if ($pathinfo === '/search/key') {
