...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->parameters = array(
            ...
            'kernel.bundles' => array(
                ...
                'searchBundle' => 'search\\searchBundle\\searchBundle',
            ...
            'database_host' => 'bd.enjambre.gov.co',
            'database_port' => 3306,
            'database_name' => 'test_carlos',
            'database_user' => 'root',
            'database_password' => 'elgg2014',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'bd.enjambre.gov.co', 'port' => 3306, 'dbname' => 'test_carlos', 'user' => 'root', 'password' => 'elgg2014', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array((dirname(dirname(dirname(__DIR__))).'/src/search/searchBundle/Resources/config/doctrine') => 'search\\searchBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'search\\searchBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('searchBundle' => 'search\\searchBundle\\Entity'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/search/searchBundle/Resources/views'), 'search');
